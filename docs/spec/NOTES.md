...
- Encrypt once / retransmit ciphertext; undecryptable packets are ACKed then
  ...
  or NAKed** — libsrt gates loss detection on decrypt success); KK=0 cleartext
  on an encrypted link is **rejected as undecryptable** (CVE-2026-55868) —
  `encryption.md` §9.3–9.4.
